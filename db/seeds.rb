...
questions = Question.create!([
    ...
    { game: game1,
      position: '2',
      title: "Quel est le nom du magazine de Reputation Squad ?",
      answer_1: 'A. Reputation Mag',
      answer_2: 'B. Digital Bible',
      answer_3: 'C. The Networker',
      answer_4: 'D. Augmented Mag',
      correct_answer: 3,
      duration: 15,
    },
    { game: game1,
      position: '3',
      title: "Quel est le coeur de métier de Reputation Squad ?",
      answer_1: 'A. Influence Augmentée',
      answer_2: 'B. Intelligence Artificielle',
      answer_3: 'C. Trading Desk',
      answer_4: 'D. Impression 3D',
      correct_answer: 1,
      duration: 15,
    },
  ])
