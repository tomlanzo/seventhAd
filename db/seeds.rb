...
questions = Question.create!([
    ...
    { game: game1,
      position: '2',
      title: "Laquelle de ces 4 valeurs n'est pas une valeur de Foule Access ?",
      answer_1: 'A. Agilité',
      answer_2: 'B. Proximité',
      answer_3: 'C. Unité ',
      answer_4: 'D. Réactivité',
      correct_answer: 3,
      duration: 15,
    },
    { game: game1,
      position: '3',
      title: "Quelle technologie est au coeur du métier de Foule Access ?",
      answer_1: 'A. La Géolocalisation',
      answer_2: 'B. Intelligence Artificielle',
      answer_3: 'C. Robotisation',
