...
questions = Question.create!([
    { game: game1,
      position: '1',
      title: "Laquelle de ces 4 valeurs n'est pas une valeur de beNext ?",
      answer_1: 'A. Humilité',
      answer_2: 'B. Gourmandise',
      answer_3: 'C. No bullshit',
      answer_4: 'D. Fun',
      correct_answer: 2,
      duration: 15,
    },
    { game: game1,
      position: '2',
      title: "Laquelle de ces 4 activités n'est pas une activité de beNext ?",
      answer_1: 'A. Product Management',
      answer_2: 'B. Space Lab',
      answer_3: 'C. Pêche aux moules ',
      answer_4: 'D. Coaching Agile',
      correct_answer: 3,
      duration: 15,
    },
    { game: game1,
      position: '3',
      title: "Quelle est la première start up issue du Space Lab ?",
      answer_1: 'A. Jump in',
      answer_2: 'B. 7thAd',
      answer_3: 'C. Tracktor',
      answer_4: 'D. ManoMano',
